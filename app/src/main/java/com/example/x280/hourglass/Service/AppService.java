...
import com.example.x280.hourglass.Drawer;
import com.example.x280.hourglass.R;
    ...
    private Runnable mRepeatCheckTask = new Runnable() {
        ...
        public void run() {
            if (!mManager.hasPermission(mContext)) {
                ...
                startService(new Intent(mContext, AlarmReceiver.class));
                Intent intent = new Intent(mContext, Drawer.class); //change to drawer
